...
public:
     ...
     * @param _ruleNode                     the rule node from which target rules will be considered
     */
    clsPhraseCandidateCollection(size_t _beginPos, size_t _endPos,  const InputDecomposer::Sentence_t& _input, const QList<RuleTable::clsRuleNode>& _ruleNodes) :
        Data(new clsPhraseCandidateCollectionData(_beginPos, _endPos, _input, _ruleNodes))
    {}
