...
//                std::cout << _node.getNodeNum() << " ||| " ;
//                for(auto Iter = this->Data->SortedByState.begin(); Iter != this->Data->SortedByState.end(); Iter++){
//                    std::cout << Iter->getNodeNum() << " " ;
//                }
//                std::cout << std::endl;
...
//    QPair<clsSearchGraphNode, bool> insert(clsSearchGraphNode& _node, bool _keepRecombined) {


//        std::cout << _node.getNodeNum() << " ||| " ;
//        for(auto Iter = SortedByState.begin(); Iter != SortedByState.end(); Iter++){
//            std::cout << Iter->getNodeNum() << " " ;
//        }
//        std::cout << std::endl;

//        auto SetInsertionResult = this->SortedByState.insert(_node);
//        if(SetInsertionResult.second == false) {
//            clsSearchGraphNode& Node = const_cast<clsSearchGraphNode&>(*SetInsertionResult.first);
...
//                        Node.swap(_node);
//            }
//            if(Node.getTotalCost() < this->BestNode.getTotalCost())
//                         this->BestNode = Node;
//            if(Node.getTotalCost() > this->WorstNode.getTotalCost())
//                         this->WorstNode = Node;
////            Q_ASSERT(_node.haveSameFuture(*SetInsertionResult.first));
//            return QPair<clsSearchGraphNode, bool>(Node, false);
//        }

//        this->SortedByTotalCost.clear();
//        if(this->BestNode.isInvalid() || _node.getTotalCost() < this->BestNode.getTotalCost())
//                   this->BestNode = _node;
//        if(this->WorstNode.isInvalid() || _node.getTotalCost() > this->WorstNode.getTotalCost())
//                   this->WorstNode = _node;
