#ifndef OPERATIONALSEQUENCEMODEL_H
#define OPERATIONALSEQUENCEMODEL_H
...
TARGOMAN_ADD_EXCEPTION_HANDLER(exOperationalSequenceModel, exFeatureFunction);

using namespace Common;
class OperationalSequenceModel : public intfFeatureFunction
{
public:

    ~OperationalSequenceModel(){}
    ...
    inline QStringList columnNames() const{
        return OperationalSequenceModel::JustUseOSMProbability.value() ?
...
private:
    ...
    TARGOMAN_SMT_DEFINE_FEATUREFUNCTION(OperationalSequenceModel, false)
...
#endif // OPERATIONALSEQUENCEMODEL_H
