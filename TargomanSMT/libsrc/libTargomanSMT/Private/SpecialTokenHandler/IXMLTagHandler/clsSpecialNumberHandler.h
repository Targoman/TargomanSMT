...
{
public:
    explicit clsSpecialNumberHandler(): intfIXMLTagHandlerModule(this->tagName())
    { }
...
private:
    TARGOMAN_DEFINE_TAG_HANDLER_MODULE(Targoman::NLPLibs::enuTextTags::Type::SpecialNumber, clsSpecialNumberHandler);
