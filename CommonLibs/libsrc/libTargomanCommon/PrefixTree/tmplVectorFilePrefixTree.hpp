...
namespace PrefixTree {
     ...
     */
    template <class clsData_t> class tmplFilePrefixTreeVectorNode : public tmplPrefixTreeVectorNode<clsData_t>, public tmplFilePrefixTreeAbstractNode<unsigned, clsData_t>
    {
    protected:
	...
	public:
        ...
        tmplFilePrefixTreeVectorNode(Index_ index, AbstractNode_ *predecessor, const clsData_t &data) : AbstractNode_(index, predecessor, data), VectorNode_(index, predecessor, data), AbstractFileNode_(index, predecessor) {}
        ...
        AbstractNode_ *followOrExpand(const Index_ &nextIndex) {
            ...
            if (position == VectorNode_::successors_.end() || (*position)->getIndex() != nextIndex) {
                ...
                tmplFilePrefixTreeVectorNode *newNode = ngFileplFilePrefixTreeVectorNode(nextIndex, this);
        ...
        AbstractNode_ *followOrExpand(const Index_ &nextIndex, const clsData_t &standardValue) {
            ...
            if (position == VectorNode_::successors_.end() || (*position)->getIndex() != nextIndex) {
                ...
                size_t offset = position - VectorNode_::successors_.begin(); // insert probably invalidates the iterator
                tmplFilePrefixTreeVectorNode *newNode = ngFileplFilePrefixTreeVectorNode(nextIndex, this, standardValue);
                VectorNode_::successors_.insert(position, newNode);
                position = VectorNode_::successors_.begin() + offset;
            }
            return *position;
