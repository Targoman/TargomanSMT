...
#ifndef TARGOMAN_NLPLIBS_LM_KENLM_PRIVATE_CLSARPAREADER_H
#define TARGOMAN_NLPLIBS_LM_KENLM_PRIVATE_CLSARPAREADER_H
...
#endif // TARGOMAN_NLPLIBS_LM_KENLM_PRIVATE_CLSARPAREADER_H
